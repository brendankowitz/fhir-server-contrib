...
public class DateTimeSearchValue : ISearchValue, ISupportSortSearchValue, IRangedComparable
{
    ...
    public bool Equals([AllowNull] ISearchValue other)
    {
        ...
        if (dateTimeSearchValueOther == null) return false;
    ...
    public int CompareTo(ISupportSortSearchValue other, ComparisonRange range)
    {
        ...
        if (otherValue == null) throw new ArgumentException($"Value to be compared should be of type {typeof(DateTimeSearchValue)}");
    ...
    public static DateTimeSearchValue Parse(string s)
    {
        ...
        var dateTime = PartialDateTime.Parse(s);
    ...
    public static DateTimeSearchValue Parse(string startDateTime, string endDateTime)
    {
        ...
        var startPartial = PartialDateTime.Parse(startDateTime);
        var endPartial = PartialDateTime.Parse(endDateTime);
    ...
    {
        if (_originalDate != null) return _originalDate.ToString();
