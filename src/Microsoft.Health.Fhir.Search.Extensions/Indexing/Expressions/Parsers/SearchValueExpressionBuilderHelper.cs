...
using EnsureThat;
using Microsoft.Health.Fhir.Extensions.Extensions;
...
namespace Microsoft.Health.Fhir.Search.Extensions.Indexing.Expressions.Parsers
{
    internal class SearchValueExpressionBuilderHelper : ISearchValueVisitor
    {
        ...
        void ISearchValueVisitor.Visit(DateTimeSearchValue dateTime)
        {
            ...
            switch (_comparator)
            {
                ...
                case SearchComparator.Ap:
                    ...
                    var differenceTicks = (long)((DateTimeOffset.UtcNow.Ticks - Math.Max(startTicks, endTicks)) * ApproximateMultiplier);
        ...
        private void EnsureOnlyEqualComparatorIsSupported()
        {
            ...
            {
                throw new InvalidSearchOperationException(Resources.OnlyEqualComparatorIsSupported);
            }
        }
