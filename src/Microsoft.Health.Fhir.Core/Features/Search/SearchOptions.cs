...
public class SearchOptions
{
    ...
    internal SearchOptions(SearchOptions other)
    {
        ...
        if (other.MaxItemCount > 0) MaxItemCount = other.MaxItemCount;

        if (other.IncludeCount > 0) IncludeCount = other.IncludeCount;
    }
    ...
    public int MaxItemCount
    {
        ...
        internal set
        {
            if (value <= 0) throw new InvalidOperationException(Core.Resources.InvalidSearchCountSpecified);
