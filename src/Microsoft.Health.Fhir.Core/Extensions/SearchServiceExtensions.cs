...
public static class SearchServiceExtensions
{
        ...
        string continuationToken = null)
    {
        ...
        if (!string.IsNullOrEmpty(continuationToken)) filteredParameters.Add(Tuple.Create(KnownQueryParameterNames.ContinuationToken, ContinuationTokenConverter.Encode(continuationToken)));
        ...
        if (totalUnusedParameters == userProvidedParameterCount) throw new PreconditionFailedException(Resources.ConditionalOperationNotSelectiveEnough);
