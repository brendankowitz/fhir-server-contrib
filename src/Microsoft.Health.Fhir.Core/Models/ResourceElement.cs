...
public class ResourceElement : IResourceElement
{
    ...
    private readonly List<string> _nonDomainTypes = new()
    {
        "Bundle",
        "Parameters",
        "Binary"
    ...
    public DateTimeOffset? LastUpdated
    {
        get
        {
            object obj = Instance.Scalar("Resource.meta.lastUpdated", _context.Value);
            if (obj != null) return PrimitiveTypeConverter.ConvertTo<DateTimeOffset>(obj.ToString());
