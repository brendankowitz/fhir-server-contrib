...
public class BundleComponentJsonNode
{
    ...
    [JsonPropertyName("request")] public BundleComponentRequestJsonNode Request { get; set; }

    [JsonPropertyName("response")] public BundleComponentResponseJsonNode Response { get; set; }

    [JsonPropertyName("search")] public BundleComponentSearchJsonNode Search { get; set; }
}
